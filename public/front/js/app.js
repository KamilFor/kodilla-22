...
const app = {
  ...
  initPages: function() {
    ...
    let pageMatchingHash = thisApp.pages[idFromHash];
    ...
    thisApp.activatePage(thisApp.pages[idFromHash]);
  ...
  initCart: function() {
    const thisApp = this;
    //console.log('thisApp2', thisApp);

    const cartElem = document.querySelector(select.containerOf.cart);
    thisApp.cart = new Cart(cartElem);

    thisApp.productList = document.querySelector(select.containerOf.menu);
    //console.log('select', thisApp.cart);
